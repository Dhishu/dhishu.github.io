...
$r= $t->fetch_assoc();
    ...
    <div class="title">
      ...
      <ul>
        ...
        <li><label style="color:white;">VIDEO LINK_</label>' . $vlink . '</li>
      ...
      <div class="d4"><form action="chnge.php" method="post">
        <p class="l1 p1">updates</p>
        <label class="l1">Name</label><br/>
        <input name="ti" value="' . $name . '" class="l2" placeholder=""/>
        <br/>
        <label class="l1">video</label><br/>
        <input name="vf" class="i2" type="file" name="vi" accept="video/*"><br>
        <label class="l1">thumbnail</label><br/>
        <input name="if" class="i2" type="file" name="tu" accept="image/*"><br>
  ...
  <script>
    function st(){
      window.open(
            ...
            "http://localhost:8080/music_Thilina/video.php?video=' . $id . '", "_blank");
    }
  </script>
</body>
</html>';
